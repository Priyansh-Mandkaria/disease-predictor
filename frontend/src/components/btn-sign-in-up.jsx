...
const BtnSignInSignUp = () => {
  return (
    <div className="mt-[5%] self-stretch flex flex-row items-start justify-start relative max-w-full text-left text-5xl text-white font-nunito-sans">
      <img
        ...
        src="/images-3@2x.png"
      />
      <div className="h-[50vh] flex-1 bg-azure flex flex-col items-start justify-start py-10 px-[42px] box-border gap-[48px_0px] min-h-[290px] max-w-full mq675:gap-[48px_0px] mq675:pl-[21px] mq675:pr-[21px] mq675:box-border">
